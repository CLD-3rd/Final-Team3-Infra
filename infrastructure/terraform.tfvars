...
name_prefix         = "matchfit-test"                    # 접두어
vpc_cidr            = "200.0.0.0/16"                 # VPC IP 범위

# 퍼블릭 서브넷 IP
public_subnet_cidr  = ["200.0.10.0/24", "200.0.20.0/24", "200.0.30.0/24"]

# 프라이빗 서브넷 IP
private_subnet_cidr = ["200.0.1.0/24", "200.0.2.0/24", "200.0.3.0/24"]

# 사용할 가용 영역
az                  = ["ap-northeast-2a", "ap-northeast-2b", "ap-northeast-2c"]

cluster_name        = "matchfit-test-eks"
...
# RDS DB 기본 설정
db_name     = "matchfit-test_db"
db_username = "admin"
db_password = "matchfit-test!123fit"  # 실제 운영 시엔 tfvars 파일을 git에 커밋하지 말고, Secret Manager 사용 권장
# Subnet Group 생성 여부
...
# S3
bucket_name = "matchfit-test-bucket"
app_bucket_name = "matchfit-test-cloudfront"
